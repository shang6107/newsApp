    ...
    <form action="getUserByPhoneNum?phoneNum=${user.phoneNum}" method="post">
        ...
        <div class="form-horizontal myForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                <@spring.formInput "user.status.reason" "class=form-control"></@spring.formInput> <span
                        id="span3"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                <@spring.formInput "user.typeName.type" "class=form-control"></@spring.formInput> <span
                        id="span3"></span>
                </div>
