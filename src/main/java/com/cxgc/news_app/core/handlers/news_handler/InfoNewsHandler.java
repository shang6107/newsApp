...
public class InfoNewsHandler {
     ...
     */
    @CrossOrigin
    @RequestMapping("/putonReport")
    public @ResponseBody Map<String,Object> putonReport(Report report){
        Map<String,Object> map=new HashedMap();
        String reportId="r"+System.currentTimeMillis();
        System.out.println("reportId = " + reportId);
        report.setId(reportId);
        report.setCreateTime(new Date());
        System.out.println("insert report = " + report);

        newsService.putonReport(report);
     ...
     */
    @CrossOrigin
    @RequestMapping("/putoutReport")
    public @ResponseBody Map<String,Object> putoutReport(Report report){
        Map<String,Object> map=new HashedMap();
        System.out.println("close id = " + report.getId());

        newsService.putoutReport(report.getId());
        return map;
    }
    ...
    public @ResponseBody Map<String,Object> checkReport(Report report){
        Map<String,Object> map=new HashedMap();

        String reportId=newsService.checkReport(report);
        System.out.println("check reportId = " + reportId);
        map.put("reportId",reportId);
    ...
    public @ResponseBody Map<String,Object> getUserById(String id){
        Map<String,Object> map=new HashedMap();

        User user=newsService.getUserById(id);
